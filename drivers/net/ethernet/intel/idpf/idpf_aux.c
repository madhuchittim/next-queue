...
/**
 * idpf_aux_init_shared - Recieve an even from auxiliary device
...
/**
 * idpf_aux_init_shared - Recieve and send a virtchnl msg on behalf of aux dev
 * @adapter: Auxiliary device info
